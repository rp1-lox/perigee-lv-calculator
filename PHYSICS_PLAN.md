...
- **R6.2**: MANEUVER time-drag along its rail (durationOverride writeback, clamped, undo-clean) + drag affordance styling (grab cursor, rail highlight while dragging — mirror the gizmo center-knob interaction).
